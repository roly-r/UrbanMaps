...
from blueprints.guias import guias_bp
...
from blueprints.mapas import mapas_bp
...
app.register_blueprint(guias_bp,url_preferix='/guia')
app.register_blueprint(mapas_bp,url_preferix='/mapas')
...
def init_database():
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS vehiculo (
            ...
            observaciones TEXT,
            FOREIGN KEY (ci_afiliado) REFERENCES guia(ci)
        )
    """)
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS COUTA_MENSUAL (
            ...
            descripcion TEXT,
            mes TEXT NOT NULL,
            FOREIGN KEY(ci) REFERENCES guia(ci)
        )
    """)
